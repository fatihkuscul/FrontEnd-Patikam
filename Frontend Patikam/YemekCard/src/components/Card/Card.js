    ...
    <div className="card">
      <div className="card-header">
        ...
        <div className="card-title-group">
          <h5 className="card-title">{props.recibe.title}</h5>
          <div className="card-date">{props.recibe.date}</div>
        </div>
      </div>
      <img className="card-image" src={props.imgLink} alt="Logo" />
      <div className="card-text">{props.recibe.description}</div>
